...
def main() -> None:
    ...
    first_reverse_index = next(index for index, point in enumerate(trajectory.points) if point.gear == "reverse")
    ...
    print("note=LQR demo tracks forward and reverse references separately; full parking needs a kinematically feasible maneuver planner.")
